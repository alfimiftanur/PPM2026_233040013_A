...
class Catatan {
  ...
  /// Konversi Catatan → JSON (untuk dikirim ke server)
  /// Format: ISO-8601 string untuk datetime
  ...
  /// Konversi JSON (dari server) → Catatan
  ...
  /// Duplikasi dengan field tertentu yang bisa diubah
